...
public class ChangePaymentRandom extends javax.swing.JFrame {
    ...
    public ChangePaymentRandom() {
        initComponents();
    }
    
    public ChangePaymentRandom(String name, String number, String codename, MainAdminFrame admin) {
        initComponents();
        jTextField1.setText(name);
        jTextField2.setText(number);
        jTextField3.setText(codename);
        this.name = name;
        this.number = number;
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        String codename1 = jTextField3.getText();
        if(name.equals("")){
            JOptionPane.showMessageDialog(null, "Не все поля заполнены!",
                        "Ошибка!",JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        String sqlString = "UPDATE fixed_assets SET `name`='"+name1+"', `price`='"+number1+"', `term_of_use`='"+codename1+
                "' WHERE `name` ='"+name+"' AND `number` = '"+number+"' AND `codename`='"+codename+"'";
        ...
        try {
            ...
            Logger.getLogger(PaymentRandom.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePaymentRandom().setVisible(true);
            }
        });
    }
