...
public class FormServices extends javax.swing.JFrame {
    private TableModel service;
 ...
 ArrayList<String> str = new ArrayList<String>();
    public FormServices() {
       /* try {
           ...
           try {
            ...
            setServicesModel("SELECT * FROM services");
        } catch (IOException ex) {
            //Logger.getLogger(MainAdminFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void setServicesModel (String executeStr) throws IOException{
       ArrayList<Services> services = new ArrayList<>();
        socketstream.sendInt(8);
        socketstream.sendString(executeStr);
        int count = socketstream.getInt();
        for(int i = 0; i < count; i++){
            String name_service = socketstream.getString();
            String description = socketstream.getString();
            String CVV = socketstream.getString();
            String who = socketstream.getString();
             services.add(new Services(name_service, description, CVV, who));
        }
	service = new ServicesTableInf(services);
    }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ButtonCreateReport, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ButtonPieChart, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(ButtonBarChart)))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ButtonDetails, javax.swing.GroupLayout.PREFERRED_SIZE, 191, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void ButtonCreateReportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ButtonCreateReportMouseClicked
        ...
        try {
            ...
            Logger.getLogger(FormServices.class.getName()).log(Level.SEVERE, null, ex);
        }
...
///////////////////////////сортировка///////////////////////////
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormServices().setVisible(true);
            }
        });
    }
