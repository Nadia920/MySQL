...
public class FormOperations extends javax.swing.JFrame {
    private TableModel operation;
 ...
 ArrayList<String> str = new ArrayList<String>();
    public FormOperations() {
       /* try {
         ...
         try {
            //setCardsModel ();
            setOperationsModel("SELECT * FROM operations");
        } catch (IOException ex) {
            //Logger.getLogger(MainAdminFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
    ...
    public void setOperationsModel (String executeStr) throws IOException{
        ...
        for(int i = 0; i < count; i++){
            Integer id = socketstream.getInt();
            String nameService = socketstream.getString();
            String numberPassport = socketstream.getString();
            /*FormCards card = new FormCards(number_card, payment_information, amount, status);
            cards.add(card);*/
             operations.add(new Operations(id, nameService, numberPassport));
        }
	//payment = new PaymentsTableInf(payments);
        operation = new OperationsTableInf(operations);
    }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                .addComponent(ButtonCreateReport, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(161, 161, 161))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
///////////////////////////сортировка///////////////////////////
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormOperations().setVisible(true);
            }
        });
    }
