...
public class Block extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Введите номер карты , которую хотите заблокировать ");

        blocknumber.setText("jTextField1");

        block.setText("Заблокировать карту");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(blocknumber, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(21, 21, 21)
                        .addComponent(block, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void blockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_blockActionPerformed
        ...
        String block = blocknumber.toString();
         socketStream.sendInt(5);
        socketStream.sendString(block);
        this.setVisible(false);
        СardBlocked cardBlocked = new СardBlocked();
        cardBlocked.setVisible(true);
        cardBlocked.setLocationRelativeTo(null);
